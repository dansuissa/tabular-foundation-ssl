#!/usr/bin/env python3
"""Build the final Bar-Ilan TFM/SSL report from validated immutable inputs.
...
All outputs are written below results/reports/bar_ilan_tfm_ssl_final/.
"""
...
OUT = ROOT / "results" / "reports" / "bar_ilan_tfm_ssl_final"
TABLES = OUT / "tables"
FIGURES = OUT / "figures"
...
"""
    ...
    (OUT / "README.md").write_text(
        "# Bar-Ilan TFM/SSL final deliverables\n\n"
        "The completed supervisor-facing report is [`final_report.md`](final_report.md).\n"
        "Machine-readable tables are under [`tables/`](tables/) and figures under "
        "[`figures/`](figures/). Reproducibility metadata is in "
    ...
    (OUT / "integrity_validation.json").write_text(
    ...
    print(f"Wrote final report to {OUT}")
