"""Neural SSL baselines: SSLAE, VIME, and SCARF.

The methods consume the same fixed sklearn-preprocessed numeric matrices as the
classical benchmark methods. PyTorch is imported lazily so this module remains
